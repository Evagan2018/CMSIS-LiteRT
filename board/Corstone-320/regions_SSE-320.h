...
//   <i> The 128 KB boot ROM is far too small for the ExecuTorch runtime +
//   <i> kernels, so code/rodata (and the Ethos-U cache buffer) are placed in
//   <i> the 2 MB FPGA SRAM. To boot on the FVP, set INITSVTOR to this base.
